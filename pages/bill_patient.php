<?php 
    ...
    echo '<div class="card mr-4 mb-2 ml-4">
        <div class="card-header">
            <form action="../config/formsprocess.php" method="post" class="form-inline">
                <div class="form-group">
                    <input type="text" name="ip_number" placeholder="IP Number" class="form-control form-control-sm mr-2">
