        ...
        <div class="row mt-4 ml-1">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control form-control-sm" value="" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card" style="margin-top: 10px; margin-bottom:10px">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label col-form-label-sm">Hospital Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label col-form-label-sm">Hospital Email</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="" id="" rows="" cols="" class="form-control form-control-sm" readonly></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="" id="" cols="" rows="" class="form-control form-control-sm" readonly></textarea>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 class="modal-title" id="exampleModalLabel">Hospital settings</h6>
                                    </div>
